...
def main(args):
    ...
    schema_id = schema_registry_client.register_schema(subject_name, Schema(schema_str, schema_type='JSON'))
    print(f"Schema registered with ID: {schema_id}")
    print(f"Schema lookup schemas :{schema_registry_client.lookup_schema('user-value', Schema(schema_str, schema_type='JSON'))}")
