...
def main(args):
    ...
    while True:
        ...
        try:
            validate(instance=user, schema=schema_str)
            print(f"Valid message received: {user}")
            # Process the valid message further
        except ValidationError as e:
            print(f"Validation Error for message: {user} - {e.message}")
            # Handle invalid message (e.g., log, dead-letter queue)
